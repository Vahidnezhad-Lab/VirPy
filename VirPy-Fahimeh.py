...
def main():
    ...
    def virus_alignment():
        cmd2 = 'hisat2 -x ' + index_vir + '/viruses_v2 -1 ' + out + '/accepted_hits.Unmapped.out.mate1 -2 ' + out + '/accepted_hits.Unmapped.out.mate2 -S ' + out + '/unmapped_aln.sam -p ' + n_thread + ' --quiet'
        print('Running ', cmd2)
        os.system(cmd2)
    ...
    def express():
        cmd7 = 'express ' + index_vir + '/viruses_v2.fasta ' + out + '/unmapped_aln_sorted.bam --no-bias-correct -o ' + out + '/eXpress/'
        print('Running ', cmd7)
        os.system(cmd7)
    ...
    def getTopVirus():
        ...
        topList = open(out + '/viruses_v2_detected.txt', 'w')
    ...
    def call_variants():
        ...
        cmd10 = 'freebayes -f ' + index_vir + '/viruses_v2.fasta -b ' + out + '/unmapped_aln_Coord_sorted.bam --min-coverage ' + min_coverage + ' > ' + out + '/VariantCalling/variants.vcf'
        print('Running ', cmd10)
        os.system(cmd10)
        cmd11 = 'java -jar ' + index_vir + '/snpEff/snpEff.jar viruses_v2 ' + out + '/VariantCalling/variants.vcf > ' + out + '/VariantCalling/variants.ann.vcf'
        print('Running ', cmd11)
        os.system(cmd11)
    ...
    def consensus():
        ...
        cmd13 = './gatk FastaAlternateReferenceMaker -R ' + index_vir + '/viruses_v2.fasta -O ' + out + '/VariantCalling/consensus.fasta -V ' + out + '/VariantCalling/variants.ann.vcf'
        print('Running ', cmd12)
        os.system(cmd12)
        print('Running ', cmd13)
        os.system(cmd13)
